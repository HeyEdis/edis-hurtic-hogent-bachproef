...
\title
    {Ontwikkelen van een geautomatiseerde end-to-end testworkflow om continu de productkwaliteit te meten bij talentguide.}
...
In de tweede fase volgt een richtlijnen en benodigdheden analyse waarbij de richtlijnen voor de vaardigheidsbestanden zijn gedefinieerd, hoe de keten samenwerkt geïllustreerd, wat de coverage niveaus zijn en de functionele en non-functionele technische richtlijnen voor elk vaardigheidsbestand. Dit waarborgt dat de AI output kan integreren binnen de codebase.
In de derde fase is het prototype ontwikkeld. Dit is een geautomatiseerde workflow dat op basis technische richtlijnen gedefinieerd in de AI agents aanstuurt om met minimale intrusie van ontwikkelaars kwalitatieve end-to-end testen te generen. 
In de laatste fase is het prototype geëvalueerd door het evaluatie vaardigheidsbestand, deze is afgestemd op alle richtlijnen uit fase twee. Hierbij is de toepasbaarheid van de technische richtlijnen gemeten.
Er wordt verwacht dat dit prototype zal dienen als een betrouwbare testprocedure die kwaliteitsborging integreert in het ontwikkelingsproces met een minimale belasting van het ontwikkelingsteam. De ontwikkelde workflow legt hierbij de technische specificaties vast van een volwaardige testingworkflow. Deze resultaten zullen leiden tot een verhoogde betrouwbaarheid van het SaaS-platform met een toekomstgerichte aanpak.
